...
router.post("/monitor/:id/statuspage", authMiddleware, createWebsiteStatusPage);
router.post("/website/:id/statuspage", authMiddleware, createWebsiteStatusPage);
router.get("/statuspage/:monitorId", getStatusPage);
router.delete("/monitor/:monitorId/statuspage", authMiddleware, deleteWebsiteStatusPage);
